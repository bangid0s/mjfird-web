      ...
      renderRow={(item) => (
        <div className="flex items-center gap-3">
          <form
            ...
            className="grid flex-1 grid-cols-2 items-center gap-3 lg:grid-cols-[3rem_1fr_1.3fr_1fr_6rem_8rem_auto_6.5rem_auto]"
          >
            <input
              name="emoji"
            ...
            <input
              ...
              className={fieldInputClasses}
            />
            <select name="tab" defaultValue={item.tab} aria-label="Tab" className={fieldInputClasses}>
